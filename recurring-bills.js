...
function boot(){if(!ensure())return;installStyles();installUI();render();bind();waitForCommitmentBridge();if(window.MGWRenderCoordinator?.register)window.MGWRenderCoordinator.register('recurring-bills',()=>{render();bind()},55)}
