...
const CACHE='moneygowhere-uat-dev51-edge-icon-v1';
const CORE=[
  ...
  './dashboard-core.js','./performance-optimizer.js','./version-badge-authority.js','./manifest.json','./assets/icons/icon.svg','./assets/icons/icon-192.jpg','./assets/icons/apple-touch-icon.jpg'
];
