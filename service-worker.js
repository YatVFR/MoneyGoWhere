const APP_VERSION='1.5.5-dev.46';
const CACHE='moneygowhere-v1.5.5-dev-46';
const CORE=[
...
async function coreStaleWhileRevalidate(event){
  ...
  try{return await update}catch(_){return caches.match('./index.html')}
}
