// MoneyGoWhere UAT — single authoritative visible build badge
(()=>{
  'use strict';
  const RELEASE='1.5.5-dev.51',TEXT=`v${RELEASE} · UAT`;
  function apply(){
    ...
    badge.title=`UAT · App ${RELEASE} · recurring-data onboarding and startup guidance`;
  }
