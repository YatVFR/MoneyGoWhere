...
(()=>{
  ...
  function apply(){
    ...
    if(!badge){
      ...
      badge.id='mgwRuntimeVersionBadge';
  ...
  function observe(){
    ...
    if(target)new MutationObserver(()=>queueMicrotask(apply)).observe(target,{subtree:true,childList:true,characterData:true});
  }
